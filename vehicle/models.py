...
class Milage(models.Model):
    car = models.ForeignKey('vehicle.Car', on_delete=models.CASCADE, null=True, blank=True, related_name='milage')
    moto = models.ForeignKey('vehicle.Moto', on_delete=models.CASCADE, null=True, blank=True, related_name='milage')
